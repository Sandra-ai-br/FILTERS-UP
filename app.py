...
def responder_agente(idade, genero, tipo, continente, pais, encontrados):
    ...
    return f"Para uma pessoa de {idade} anos, gênero {genero}, com uma startup em fase de {tipo} sediada em {pais} ({continente}), foram encontrados {encontrados} edital(is). {incentivo}"
